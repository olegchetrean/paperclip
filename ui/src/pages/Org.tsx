...
export function Org() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message="Selecteaza o companie pentru a vedea organigrama." />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message="Niciun agent in organizatie. Creeaza agenti pentru a construi organigrama."
        />
      )}
