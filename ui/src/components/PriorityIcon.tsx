...
const priorityConfig: Record<string, { icon: typeof ArrowUp; color: string; label: string }> = {
  critical: { icon: AlertTriangle, color: priorityColor.critical ?? priorityColorDefault, label: "Critic" },
  high: { icon: ArrowUp, color: priorityColor.high ?? priorityColorDefault, label: "Ridicat" },
  medium: { icon: Minus, color: priorityColor.medium ?? priorityColorDefault, label: "Mediu" },
  low: { icon: ArrowDown, color: priorityColor.low ?? priorityColorDefault, label: "Scazut" },
};
