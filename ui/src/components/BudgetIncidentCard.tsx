        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-[11px] uppercase tracking-[0.22em] text-red-200/80">
              {incident.scopeType} oprire fortata
            </div>
            ...
            <CardDescription className="mt-1 text-red-100/70">
              Cheltuielile au atins {formatCents(incident.amountObserved)} fata de o limita de {formatCents(incident.amountLimit)}.
            </CardDescription>
          </div>
        ...
        <div className="flex items-start gap-2 rounded-xl border border-red-400/20 bg-red-500/10 px-3 py-2 text-sm text-red-50/90">
          ...
          <div>
            {incident.scopeType === "project"
              ? "Executia proiectului este pe pauza. Munca noua in acest proiect nu va incepe pana cand rezolvi incidentul de buget."
              : "Acest domeniu este pe pauza. Heartbeat-uri noi nu vor incepe pana cand rezolvi incidentul de buget."}
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border/60 bg-background/60 p-3">
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row">
            ...
            >
              ...
              {isMutating ? "Se aplica..." : "Mareste bugetul si reia"}
            </Button>
          </div>
          {parsed !== null && parsed <= incident.amountObserved ? (
            <p className="mt-2 text-xs text-red-200/80">
              Noul buget trebuie sa depaseasca cheltuielile observate curente.
            </p>
          ) : null}
        </div>
