...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: "Creeaza un agent nou",
      description: "(scrie ce tip de agent vrei aici)",
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">Adauga un agent nou</span>
          <Button
            variant="ghost"
            size="icon-xs"
          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Recomandam sa lasi CEO-ul sa se ocupe de configurarea agentului — cunoaste
                  structura organizatiei si poate configura raportarea, permisiunile si
                  adaptoarele.
                </p>
              </div>
              ...
              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                ...
                Cere CEO-ului sa creeze un agent nou
              </Button>
            ...
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Alege tipul de adaptor pentru configurare avansata.
                </p>
              </div>
